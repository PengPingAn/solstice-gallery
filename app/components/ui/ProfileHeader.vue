...
<template>
  ...
  >
    ...
    <div class="text-center md:text-left pt-2 space-y-4 max-w-2xl">
      ...
      <div>
        <p class="text-lg md:text-xl text-neutral-400 font-light leading-relaxed">"{{ poem }}"</p>
        <p class="text-lg md:text-xl text-neutral-400 font-light leading-relaxed text-right">
          —— {{ source }}
        </p>
