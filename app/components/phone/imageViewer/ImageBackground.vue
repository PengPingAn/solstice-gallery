...
//   () => props.currentImage,
//   (newImage) => {
//     if (newImage?.thumbUrl) {
//       switchBackground(newImage.thumbUrl)
//     } else {
//       backgroundImageUrl.value = DEFAULT_BACKGROUND
//       backgroundImageLoaded.value = true
//     }
  ...
  <div class="fixed inset-0" style="opacity: 1">
    ...
    <div
      ...
      :style="{
        ...
        filter: 'blur(50px) brightness(1.5) saturate(1.2)',
        transition: 'background-image 0.3s ease-out, filter 0.3s ease-out, opacity 0.3s ease-out',
